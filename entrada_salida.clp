(deffunction menuPeticion ()
	...
	(printout t "3: Determinar prioridad por la que se recomiendan las aplicaciones (descargas valoracion espacio precioAsc precioDesc)." crlf)
	(printout t "4: Determinar el espacio máximo que ocuparán las aplicaciones." crlf)
